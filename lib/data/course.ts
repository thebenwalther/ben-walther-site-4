...
export const courseDays: CourseDay[] = [
  ...
  },
  {
    ...
    body: "Every stuck place is protected by a quiet deal: stay safe, avoid the risk, keep being right about how hard it is. Today you name your deal — gently — because you can't renegotiate terms you can't see.",
  },
  {
    day: "Day 4",
  ...
  },
  {
    ...
    body: "Self-trust is rebuilt one kept promise at a time. Today you turn your small step into a specific, time-bound commitment with a way to be accountable — and you take it. That's the reset: not a transformation, a true move.",
  },
];
